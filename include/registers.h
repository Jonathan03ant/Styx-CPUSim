/**
  * @file registers.h
  * @brief Register File, Public API
  *
  * Public API, provides functions and access to RegisterFile
  * Contains GNR Register
  */
...
/*
  RegisterFile_t alias, for GNR file in _s
  Struct for General Register file/pc/flags
*/
