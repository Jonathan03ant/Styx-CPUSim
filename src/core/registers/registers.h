...
regval_t reg_read_pc(RegisterFile_t *rf);                                                   // Read PC
...
flag_bit_t reg_read_flag_bit(const RegisterFile_t *rf, flags_t flag_maask);                 // Read individual bits (ZNCV)
void    reg_set_flag_bit(const RegisterFile_t *rf, flags_t  flag_mask, flag_bit_t value);
